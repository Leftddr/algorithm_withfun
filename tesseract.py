...
if len(captchaResponse) == 5:
    params = {"captcha_token" : captchaToken, "captcha_sid" : captchaSid, "form_id" : form_build_id, "captcha_reponse" : captchaResponse, "name" : "Bong Won"
    ...
    reponseObj = BeautifulSoup(r.text, "html.parser")
